    ...
    <?php 
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            $secondname = trim($_POST['secondname']);
             ...
             if(empty($error)){
                 register_user($username, $email, $password, $firstname, $secondname);
             }
        }
?>
                ...
                <h1>Register</h1>
                    <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="secondname" id="secondname" class="form-control" placeholder="Enter Second Name" autocomplete="on" value="<?php echo isset($secondname) ? $secondname : '' ?>">
                        </div>
